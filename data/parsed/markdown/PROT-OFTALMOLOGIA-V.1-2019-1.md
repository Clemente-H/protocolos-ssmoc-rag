# PROT-OFTALMOLOGIA-V.1-2019-1

--- Página 1 ---

![SALUD OCCIDENTE SERVICIO DE SALUD METROPOLITANO OCCIDENTE logo](page_1_image_1_v2.jpg)
...
```mermaid
graph TD
    A[DISMINUCION AGUDA DE LA AGUDEZA VISUAL] --> B[Ojo Blanco]
    A --> C[Ojo Rojo Profundo: asociado a disminución de AV, dolor ocular, fotopsias]

    B --> D["- **Hemorragia Vitrea**: FR: DM, HTA/ clínica: visión de mancha roja, perdida de vision a la luminosidad, disminución de AV- **Desprendimiento de retina**: clínica: caida de telon, fotopsias, entopsias, disminución brusca de AV- **Neuritis óptica**: dolor al movimiento del ojo, escotoma central, reflejo pupilar ausente"]
    D --> E[P0/ Poli de Choque]

    C --> F[P0/ Poli de Choque]
    C --> G[Miosis]
    C --> H[Midriasis arreflectica]

    G --> I["- Uveitis: fotopsias, epifora / descartar sifilis, reumatologico- Queratitis: FR (ojo seco, laboral, actinica, uso corticoides, IS)"]
    H --> J["- Glaucoma agudo: halos de colores alrededor de las luces, lagrimeo, blefaroespasmo, dolor intenso"]
```
...
```mermaid
graph TD
    Start[LESIONES INFLAMATORIAS] --> Orzuelo[Orzuelo: Inflamación aguda y supurativa de un folículo piloso de pestaña / edema localizado, hiperemia, pápula o pústula]
    Orzuelo --> OrzueloTrat[Gentamicina, tobramicina o cloranfenicol en colirio 1 gota cada 3 hrs por 7 días / Higiene del borde palpebral con hisopo de algodón con SF / aplicar compresas tibias, que se colocan en la cara durante unos 15 minutos cuatro veces al día en el área de la lesión con posterior masaje y limpieza suave / evitar uso de cosméticos]
    OrzueloTrat --> OrzueloComp{Sospecha de celulitis palpebral}
    OrzueloComp -->|SI| P1OftalmoUAPO[P1/ Oftalmo o UAPO]

    Start --> Chalazion[Chalazión: Nódulo subcutáneo en el tarso bien definido, elevado, poco dolorosa, estéril.]
    Chalazion --> ChalazionTrat[Higiene del borde palpebral con hisopo de algodón -no más allá de la unión muco-cutánea-, con suero fisiológico. Si existe secreción palpebral indicar aseo con shampoo neutro diluido con gasa estéril de 2 a 3 veces al día / Masajes 2 veces al día / Si hay algún signo inflamatorio agudo aplicar compresas tibias, que se colocan en la cara durante unos 15 minutos cuatro veces al día en el área de la lesión / evitar uso de cosméticos]
    ChalazionTrat --> ChalazionCrit{<ul><li>Chalazión asociado a disminución del campo visual</li><li>Con granuloma expuesto a aversión palpebral</li><li>Chalazión recurrente en el mismo lugar -se debe descartar causa neoplásica-</li></ul>}
    ChalazionCrit -->|SI| P1Oftalmo[P1/ Oftalmo]
    ChalazionCrit -->|NO| ChalazionRef[Refractario a tto en 3 meses]
    ChalazionRef -->|SI| P2Oftalmo[P2/ Oftalmo]

    Start --> Blefaritis[Blefaritis: Inflamación de los bordes palpebrales, ardor al juntar párpados, fotofobia, epífora, borde palpebral eritematoso, secreción aglutinada en la base de las pestañas en forma de collaretes.]
    Blefaritis --> BlefaritisCrit{Asociado a dolor, sensibilidad a la luz, disminución de AV, anormalidades de la cornea -erosiones, ulceras, cicatrices- o sospecha clínica en pacientes menores de 15 años}
    BlefaritisCrit -->|SI| P1Oftalmo2[P1/ Oftalmo]
    BlefaritisCrit -->|NO| BlefaritisTrat[Aplicar compresas tibias dos a cuatro veces al día, masaje de párpados, lavado de párpados / evitar alérgenos como cosméticos, fumar cigarrillos, lentes de contacto / lágrimas artificiales 1 gota cada 6 horas según sea necesario]
    BlefaritisTrat --> BlefaritisRef[Refractario a tto en 30 días]
    BlefaritisRef -->|SI| P2UAPO[P2/ UAPO]

    Start --> Pterigion[**Pterigion**]
    Pterigion --> PterigionCrit{Diplopía, disminución de AV, alteración motilidad ocular}
    PterigionCrit -->|SI| P1Oftalmo3[P1/ Oftalmo]
    PterigionCrit -->|NO| PterigionSint{Sintomático: Ardor, dolor, prurito, epífora, sensación cuerpo extraño}
    PterigionSint -->|SI| P2UAPO2[P2/ UAPO]
```
...
![Logo of Servicio de Salud Metropolitano Occidente and Chile en marcha](page_18_image_1_v2.jpg)
