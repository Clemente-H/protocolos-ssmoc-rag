...
```mermaid
graph TD
    Start[REFLUJO GASTROESOFAGICO PATOLOGICO CIE10-K219 : diagnostico CLINICO pirosis, regurgitación] --> Alarma{Síntomas o signos de alarma 1}
    
    Alarma -- SI --> EDA[Estudio Endoscópico según disponibilidad]
    Alarma -- NO --> Medidas[Medidas Antireflujo 2]
    
    Medidas --> Tto1[De acuerdo a disponibilidad:Omeprazol 20mg/dia por 30 días oRanitidina 150 mg al día por 30 días]
    Tto1 --> Resp1{Sin respuesta al mes de tto}
    Resp1 --> Tto2[Ajustar dosis de fármacos:Omeprazol 40mg al día oRanitidina 300mg al díaEvaluar medidas antireflujo]
    Tto2 --> Resp2{Sin respuesta a los 2 meses de tto}
    Resp2 --> RGERefractario[RGE refractario]
    RGERefractario --> EDA2[Endoscopia digestiva según disponibilidad]
    
    EDA2 -- Normal --> Tto3[Tto con IBP 40mg cada 12 horas +-prokineticos domperidona ometoclopramida 10mg c8-12h por 30 dias]
    Tto3 --> Resp3{Sin respuesta al mes de tto}
    Resp3 --> Derivar1[Derivar como RGEP refractario P2 /Med Int/ CIE10- K21.9]
    
    EDA2 -- Según hallazgos --> Derivar2[Derivar según hallazgos]
    
    EDA --> Barret[Esófago de Barret confirmado por biopsia]
    Barret -- SI --> IBP_Perm[IBP a permanencia ajuste de dosispara control de síntomas de RGEP]
    IBP_Perm --> ControlBarret[• Sin displasia = control endoscópico cada 1 año en APS• Con displasia: derivar]
    
    EDA --> Esofagitis[Esofagitis]
    Esofagitis -- SI --> Clasif[**Clasificación C-D:** Iniciar tto con IBP 40mg al dia y derivar**Clasificación A-B:** Iniciar tto con IBP 40mg al día por 2 meses en APS, si persisten los síntomas o EDA de control continua con esofagitis]
    Clasif -- SI --> Derivar3[Derivar: P2 / Med Int/CIE10- K20.X]
```
...
![Arrow down](page_13_image_1_v2.jpg)
![Arrow down](page_13_image_5_v2.jpg)

**Ulcera Gástrica**
**Ulcera Duodenal**

![Arrow down](page_13_image_2_v2.jpg)
![Arrow down](page_13_image_3_v2.jpg)
...
![Arrow down](page_13_image_4_v2.jpg)
![Arrow down](page_13_image_7_v2.jpg)
...
```mermaid
graph TD
    Start[Síntomas o signos de alarma 1] -- SI --> Colonoscopia[Colonoscopia según disponibilidad]
    Colonoscopia --> Cancer[Sospecha Cáncer colorectal C189-C20X] --> DerivarGES[Derivar según GES]
    Colonoscopia --> DiverticularC[Enf diverticular complicada: hemorragia digestiva baja o diverticulitis] --> Urgencia[Derivar a Servicio Urgencia/P0]
    Colonoscopia --> DiverticularS[Enfermedad Diverticular Simple presencia de divertículos y síntomas de dispepsia] --> Dieta[Indicar en forma gradual un régimen rico en fibra y líquidos + Antiespasmodico y/o anticolinergico SOS]
    Colonoscopia --> EII[Enfermedad Inflamatoria Intestinal K509-K519] --> DerivarGastro[Derivar como P1/ Gastro/ CIE10- K509-K519]

    Start -- NO --> Gineco[En mujeres descartar patología ginecológica con ecografía transvaginal según disponibilidad]
    Gineco -- Normal --> EcoAbd[Ecografía abdominal según disponibilidad]
    EcoAbd -- Normal --> Colopatia[Sospecha de Colopatía Funcional 2]
    Colopatia -- SI --> Manejo[Medidas no Farmacológicas A + Manejo sintomático para el dolor: antiespasmodicos SOS con o sin Moduladores del dolor amitriptilina, imipramina por 3 meses considerar contraindicaciones]
    
    Manejo --> Constipacion[Predominio Constipación] --> VerFlujoC[Ver flujo respectivo]
    Constipacion -- NO --> Diarrea[Predominio Sd diarreico] --> VerFlujoD[Ver flujo respectivo]
    
    Manejo -- Falla en 3 meses --> Refractario[Derivar como síndrome intestino irritable refractario P2/ Med Int / CIE10- K599]
```
...
```mermaid
graph TD
    Start[Síntomas o signos de alarma 1] -- SI --> Colonoscopia[Colonoscopia con biopsia escalonada según disponibilidad]
    Colonoscopia -- Según hallazgos --> Derivar1[Derivar]
    
    Start -- NO --> Medidas[Medidas no farmacológicas A, restricción de lactosa por 2 semanas, suspensión de fármacos que pudieran causar diarrea, solicitud de VIH y hemorragia oculta]
    
    Medidas -- Falla tto y/o exámenes normales --> Descartar[Descartar causa sistémica y/o infecciosa]
    
    Descartar -- Solicitar --> Examenes[Glicemia, TSH, T4 libre, creatinina, electrolitos, GOT, GPT, GGT, FA, albumina, hemograma, coproparasitologico, coprocultivo, leucocitos fecales según disponibilidad  Ac antitranglutaminasa según disponibilidad]
    
    Descartar -- Normal --> Eco[Ecografía abdominal según disponibilidad]
    
    Eco -- Normal --> SospechaColo[Sospecha de Colopatía Funcional con predominio Síndrome Diarreico]
    
    Examenes -- Exámenes alterados --> SospechaMal[Sospecha de Síndrome de Malabsorción]
    
    SospechaMal -- SI --> Endoscopia[Endoscopia Digestiva con biopsia duodenal según disponibilidad]
    
    Endoscopia -- Alterada --> DerivarGastro[Derivar P1/ Gastro / Malabsorción intestinal CIE10- K909, Enfermedad Celiaca CIE10-K900]
    
    SospechaColo -- SI --> Evaluar[Evaluar tratamiento con loperamida 2mg 15min antes comidas max 16mg según necesidad. Evaluar uso de amitriptilina 12,5mg /noche por 3 meses considerar contraindicaciones]
    
    Evaluar -- Falla --> DescartarSobre[Descartar sobrecrecimiento bacteriano]
    
    DescartarSobre -- Prueba terapeutica --> Antibioticos[Metronidazol vo 500mg cada 8-12h o Amoxicilina-clavulanico vo 875mg c12h o Ciprofloxacino vo 500mg c12 o Rifaximina 400mg c8h por 10 días]
    
    Antibioticos -- Falla --> DerivarMed[Derivar P2 / Med Interna/ CIE10- K591]
```
...
![Arrow pointing down](page_17_image_2_v2.jpg)
...
![Arrow pointing down](page_17_image_1_v2.jpg) NO
...
![Arrow pointing down](page_17_image_5_v2.jpg) Falla en 2 meses
...
![Arrow pointing down](page_17_image_3_v2.jpg) Falla a los 30 días de tto

> Indicar laxantes osmoticos (2) Ver tabla laxantes

![Arrow pointing down](page_17_image_4_v2.jpg) Falla a los 30 días de tto
...
```mermaid
graph TD
    Start[DAÑO HEPATICO CRONICO: Solicitar: GOT, GPT, GGT, FA, BT, %Protrombina, Albumina] --> Colestasico[Patrón Colestasico:FA, BT, GGT > GOT, GPT]
    Start --> Hepatocelular[Patrón Hepatocelular:GOT, GPT > FA, GGT, BT]

    Colestasico --> SI1{SI}
    SI1 --> Eco[Ecografía abdominal segúndisponibilidad]
    
    Eco --> Dilatada[Via biliardilatada]
    Eco --> Normal[Via biliarnormal]
    
    Dilatada --> Cirugia[Derivar aCirugíaDigestiva P1]
    Normal --> GastroP1[Derivar aGastro P1]

    Hepatocelular --> Alcohol[Antecedente de consumoperjudicial de alcohol]
    
    Alcohol -- SI --> Rehab[Ingreso a programa derehabilitación APS]
    Rehab --> DerivarMed1[Derivar MedInterna / P2 / CIE-10 K703]
    
    Alcohol -- NO --> Otros[• Esteatohepatitis no OH• Hepatitis crónica: viral,droga, autoinmune• Enf metabólicas]
    
    Otros -- SI --> DerivarMed2[Derivar Med Interna /P1 / CIE-10 / K716Hepatitis autoinmune:Gastro / P1 / K754]

    Complicaciones[<b>Complicaciones del DHC</b>• Peritonitis Bacteriana Espontanea• Hemorragia Digestiva• Encefalopatía Hepática G>=3• Síndrome Hepato renal• Ascitis refractaria a tratamiento Grado 2] -- SI --> SU[Derivar a SU]
    
    Complicaciones -- NO --> Manejo[<b>Manejo del DHC</b>• Prohibir ingesta de OH, restricción de sal• Aporte Vit complejo B y acido fólico• Prevención de hemorragia digestiva por varices esofágicas confirmadas por EDA : propanolol según PA, FC con ECG previo +EDA cada 1 a 2 años• Encefalopatía hepática: Evitar estreñimiento, sedantes, transgresiones dietéticas• Disminuir flora colonica: lactulosa para conseguir 1 a 2 deposiciones al dia semiblandas]
```
...
```mermaid
graph TD
    A["**SINDROME ICTERICO: Bilis total, bilis directa, FA, GGT**"] --> B["**Bilis NO conjugada o Indirecta**"]
    A --> C["**Bilis Conjugada o Directa alta aislada**"]
    A --> D["**Patrón colestasico**"]

    B --> E["Hemograma + recuento dereticulocitos:• Anemia hemolítica• Eritropoyesis ineficaz"]
    E -- SI --> F["Derivar aHematologia"]
    E -- NO --> G["Alteración captación-conjugación (Sd CriglerNajar) = Derivar pediatria P1Sd de Gilbert = DerivarMedicina Interna P2"]

    C --> H["Bilis directa aislada:Dubin Johnson – Rotor =Derivar Pediatria P1"]

    D --> I["Ver flujo * DHC conpatrón colestasico"]
```
...
![Servicio de Salud Metropolitano Occidente logo](page_24_image_1_v2.jpg)
