# PROT-CARDIOLOGIA-ADULTO-V.2-2021-1
...
```mermaid
graph TD
    Start[Sospecha Diagnóstica] -->|Solicitar según disponibilidad| Confirm[Confirmación HTA]
    Confirm -->|SI| PCV[Ingreso PCV]
    PCV --> Sec[Sospecha de HTA secundaria A]
    Sec -->|SI| Deriv1[Derivar según mapa GES / CIE10-I10X]
    Sec -->|NO| Org[Compromiso órgano blanco B]
    Org -->|SI| Control[Control intensivo en APS/ paciente es considerado de alto RCV]
    Org -->|NO| Treat[Tratamiento farmacológico para logro de metas según RCV y fragilidad del paciente.]
    Treat -->|Falla| Check[Descartar mala adherencia farmacológica, trastorno depresivo, fármacos o hábitos que eleven la presión arterial, HTA de delantal blanco]
    Check -->|Descartado| Refrac[HTA refractaria C]
    Refrac --> Deriv2[Derivar según mapa GES / CIE10-I10X]
```
...
![arrow down with NO label](page_13_image_6_v2.jpg)
...
![arrow down with NO label](page_13_image_4_v2.jpg)
...
```mermaid
graph TD
    Start[DOLOR TORACICO DE ORIGEN CORONARIO] --> Q1{Sospecha clínica de Angina Inestable A o SCA}
    Q1 -- SI --> A1[Solicitar ECG y derivar SU / P0 / CIE10- I200]
    Q1 -- NO --> Q2{Sospecha clínica de Angina Estable B}
    Q2 -- SI --> A2[Solicitar ECG, optimizar terapia medica y derivar P2 / Medicina Interna / CIE10- I259]
    Q2 -- NO --> Q3{Hallazgo de ondas q patológicas en paciente asintomático}
    Q3 -- SI --> A3[Derivar P2 / Medicina Interna / CIE10- I252]
```
...
![Flowchart of arrhythmia diagnosis and referral protocols](page_17_image_1_v2.jpg)
...
```mermaid
graph TD
    Start[ARRITMIAS 2ºPARTE] --> BAV1[Bloqueo Auriculoventricular 1°]
    Start --> BAV_Other[BAV 2ªBAV 3ªBloqueo bifascicular BBloqueo trifascicular C]
    Start --> EV[Extrasístole ventricular]

    BAV1 --> Sintomas{Sintomático disnea, lipotimia, sincope}
    Sintomas -- SI --> Descartar[Descartar causas potencialmente reversibles A y derivarP1/ MI/ CIE 10: I440]

    BAV_Other -- SI --> DerivarGES[Derivar según mapa GES. Considerar evaluar derivación a urgencias]

    EV --> Cardiopatia{Presencia de cardiopatía estructural y/o antecedente de IAM, valvulopatía y/o sintomática disnea, ángor, síncope}
    Cardiopatia -- SI --> P1Cardio[P1/ MI-CardioCIE10: I493]
    Cardiopatia -- NO --> Complejidad{Bigeminada, en dupleta o tripleta}
    Complejidad -- SI --> P2MedInterna[P2/ Med InternaCIE10: I493]
    Complejidad -- NO --> APS[Seguimiento en APS con control de frecuencia cardiaca con beta bloqueador para lograr objetivo de FC 55-60 lpm]
```
...
* Guia Clinica de Insuficiencia Cardiaca. (2105). Sociedad Chilena de Cardiología y Cirugía Cardiovascular. Ministerio de Salud. Gobierno de Chile
...
* Síndrome coronario agudo sin elevación del segmento ST . T. Segura de la Cal, S.A. Carbonell San Román y J.L. Zamorano Gómez. Medicine. 2013;11(37):2240-7
