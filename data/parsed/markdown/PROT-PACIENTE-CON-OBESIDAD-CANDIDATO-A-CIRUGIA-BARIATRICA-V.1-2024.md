# PROT-PACIENTE-CON-OBESIDAD-CANDIDATO-A-CIRUGIA-BARIATRICA-V.1-2024

--- Página 1 ---

| ![Hospital San Juan de Dios logo](page_1_image_2_v2.jpg)                                                                           | SERVICIO DE SALUD METROPOLITANO OCCIDENTE<br/>HOSPITAL SAN JUAN DE DIOS-CDT<br/>\*\*Atención Multidisciplinaria del Paciente con Obesidad, Candidato a Cirugía Bariatrica\*\* | Código: DOC – CIR 23     |
| ---------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
...
![Hospital San Juan de Dios - Unidad de Calidad, Seguridad del Paciente y Control IAAS stamp](page_1_seal_1_v2.jpg)

--- Página 2 ---

| ![Hospital San Juan de Dios - CDT Asistencial Docente "El Primero de Chile" logo](page_2_image_1_v2.jpg)<br/>Servicio Cirugía<br/>Servicio Nutrición | SERVICIO DE SALUD METROPOLITANO OCCIDENTE<br/>HOSPITAL SAN JUAN DE DIOS-CDT<br/><br/>\*\*Atención Multidisciplinaria del Paciente con<br/>Obesidad, Candidato a Cirugía Bariatrica\*\* | Código: DOC – CIR 23<br/>Edición: 1<br/>Elaboración: Junio 2024<br/>Página 2 de 10<br/>Vigencia: Noviembre 2029 |
| ---------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
...
![Watermark logo](page_5_image_2_v2.jpg)

--- Página 6 ---

| ![Hospital San Juan de Dios - CDT Asistencial Docente "El Primero de Chile" logo](page_6_image_1_v2.jpg) | SERVICIO DE SALUD METROPOLITANO OCCIDENTE<br/>HOSPITAL SAN JUAN DE DIOS-CDT<br/><br/>\*\*Atención Multidisciplinaria del Paciente con<br/>Obesidad, Candidato a Cirugía Bariatrica\*\* | Código: DOC – CIR 23     |
| -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
...
```mermaid
graph TD
    A["Primera evaluación y seguimiento por la Unidad Nutrición Clínica"] --> B["Derivación a Psicología Bariátrica"]
    A --> C["Solicitud de evaluación pre-operatoria porespecialidades o estudios adicionales si seconsidera pertinente (c)"]
    B --> D
    C --> D
    subgraph D ["Se otorga el pase pre-operatorio si:"]
        D1["* Paciente mantiene peso corporal estable (peso igual o menor al del momento de su derivación)."]
        D2["* No tiene contraindicación desde la perspectiva de salud mental y conducta alimentaria."]
        D3["* Patologías de base controladas y pase pre-operatorio por parte de especialidades en caso de que haya sido solicitado."]
        D4["* Se considera apto según criterio del equipo clínico: nutrición, nutriología y psicología."]
    end
    D --> E
    subgraph E [" "]
        E1["* Contra-referencia a su centro derivador para mantener seguimiento hasta la intervención con pauta inicial por 10 días indicada por nutricionista de equipo y orden de exámenes para control post-operatorio."]
        E2["* Derivación a Medicina Física y Rehabilitación del HSJD para evaluación kinesica si corresponde (d)"]
        E3["* Derivación a la Unidad Pre-quirúrgica."]
    end
    E --> F["La Unidad Pre-quirúrgica gestiona evaluación por Cirugía Bariátrica yse define y planifica intervención quirúrgica"]
    F --> G["Ingreso a lista de espera de Cirugía Bariátrica (e)"]
```
...
```mermaid
graph TD
    CB[Cirugía Bariátrica] --> CP[Controles post-operatorios]
    CP --> N[Nutrición f]
    CP --> NU[Nutriología f]
    CP --> P[Psicología f]
    CP --> C[Cirugía]
    ...
    subgraph "1er control"
    N1[A los 10 días vía telefónica]
    NU1[Primeros 30 días]
    P1[Al mes]
    C1[A los 15 días]
    K1[Al mes Por lo menos 10 sesiones según el criterio del profesional]
    end

    subgraph "2do control"
    N2[A los 20 días]
    NU2[A los 3 meses]
    P2[A los 3 meses]
    C2[A los 3 meses]
    ...
    subgraph "4to control"
    N4[A los 2 meses]
    NU4[A los 9 meses]
    P4[Al año]
    end

    subgraph "5to control"
    N5[A los 3 meses]
    NU5[Al año]
    end

    subgraph "6to control"
    N6[A los 6 meses]
    end

    subgraph "7mo control"
    N7[Al año]
    end
...
| ![Hospital San Juan de Dios - CDT Asistencial Docente "El Primero de Chile" logo](page_9_image_1_v2.jpg)<br/>Servicio Cirugía<br/>Servicio Nutrición | SERVICIO DE SALUD METROPOLITANO OCCIDENTE<br/>HOSPITAL SAN JUAN DE DIOS-CDT<br/>\*\*Atención Multidisciplinaria del Paciente con Obesidad, Candidato a Cirugía Bariatrica\*\* | Código: DOC – CIR 23     |
| ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
|                                                                                                                                                      |                                                                                                                                                                               | Edición: 1               |
|                                                                                                                                                      |                                                                                                                                                                               | Elaboración: Junio 2024  |
|                                                                                                                                                      |                                                                                                                                                                               | Página 9 de 10           |
